...
- [ ] **GEQ-2 Graphic EQ — nine bands, real cuts, and a cab preset:** the card now has bands at 50/100/200/400/800/1.6k/3k/5k/8k plus **Low cut** and **High cut** selects and two buttons. Press **Guitar cab** on a clean sound with no IR loaded: it should immediately sound like a guitar speaker rather than a DI — the fizz and pick-scratch above 5 kHz gone, a bit more body around 100 Hz, more bite at 3 kHz. **Flat** puts it back. Check the level doesn't jump when you engage it (measured within 0.6 dB of bypass).
