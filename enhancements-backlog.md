...
**Status:** proposal / picklist — nothing here is committed until selected. BT-13 has shipped; 14 items are selected and scoped for the next release — see [release-v0.4-spec.md](research/release-v0.4-spec.md) (tagged **v0.4** in the picklist below).
